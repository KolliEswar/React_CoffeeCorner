        ...
        <div className='container min-h-[550px] flex justify-center items-center py-12 sm:py-0'>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                    ...
                    <p data-aos="fade-up" className='text-sm text-gray-500 tracking-wide leading-5'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus eos fuga repudiandae perspiciatis. Molestias, nesciunt fugit ut.</p>
                    ...
                    <div className='grid grid-cols-2 gap-6'>
                        ...
                        <p className='text-gray-500 text-sm'>{" "} 
                            Much like writing code, brewing the perfect cup of tea requires patience, and a dash of passion to create a comforting blend of flavors.
                        </p>
                        </div>
                    </div>
