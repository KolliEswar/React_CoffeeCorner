...
const ServicesData = [
    {
        ...
        name: "Espresso",
        description:
         "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio accusamus blanditiis repellat illo minus optio nesciunt ad doloremque quia ea veritatis cumque veniam voluptatum ducimus, quod id iure harum illum.",
         aosDelay: "100"
    },
    {
        id: 2,
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className='p-4 text-center'>
                                    ...
                                    <p className='text-gray-500 group-hover:text-white duration-200 text-sm line-clamp-2'>{data.description}</p>
                                </div>    
                            </div>
                        );
                    })
